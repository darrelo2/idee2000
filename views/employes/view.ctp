...
<div class="related">
	...
	<?php
		...
		array('escape' => false,"title"=>sprintf("Afficher toutes les informations ",true),"style"=>"text-decoration:none; text-align:rigth;margin-left:30px;")
				);
		?>
		<?php
		echo $this->Html->link(
		...
		array('escape' => false,"title"=>sprintf("Supprimer cet employé",true),"style"=>"text-decoration:none; text-align:rigth;margin-left:30px;"),
...
<div class="related">
	...
	<?php
		...
		array('escape' => false,"title"=>sprintf("Modifier les informations",true),"style"=>"text-decoration:none; text-align:rigth;margin-left:30px;")
				);
		?><?php
		echo $this->Html->link(
		$this->Html->image('themeAdmin/icons/sup.png', array('width'=>'20','height'=>'20','alt'=>'photo', 'border' => '0')),
